...
contract FoMoXD is EFoMoXD {
    ...
    /* --------------------- Round Timer -------------------- */
    // uint256 public constant roundInitTime_ = 60 seconds; // round timer starts at this
    // uint256 public constant roundIncTime_ = 10 seconds; // every full key purchased adds this much to the timer
    // uint256 public constant roundMaxTime_ = 60 seconds; // max length a round timer can be
    // uint256 public roundGapTime_ = 10 seconds;
